---
title: "Map of The MBTA Transit System in Massachusetts"
...
## Function to Convert API Data

This function will help to clean and prepare the feature and geometry data collected through the various API requests sent to 
the MassDOT MBTA links. 
...
## Collect Various Data from the API Requests
...
## Prepare some Helpers for the Map
